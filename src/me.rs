...
mod nasm {
  ...
  extern {
    ...
    fn rav1e_sad16x16_avx(
      src: *const u8, src_stride: libc::ptrdiff_t, dst: *const u8,
      dst_stride: libc::ptrdiff_t
    ) -> u32;

    fn rav1e_sad32x32_avx(
      src: *const u8, src_stride: libc::ptrdiff_t, dst: *const u8,
      dst_stride: libc::ptrdiff_t
    ) -> u32;

    fn rav1e_sad64x64_avx(
      src: *const u8, src_stride: libc::ptrdiff_t, dst: *const u8,
      dst_stride: libc::ptrdiff_t
    ) -> u32;

    fn rav1e_sad128x128_avx(
      src: *const u8, src_stride: libc::ptrdiff_t, dst: *const u8,
      dst_stride: libc::ptrdiff_t
    ) -> u32;
  }
  ...
  unsafe fn sad_avx(
    ...
    let func = match step_size.ilog() {
      3 => rav1e_sad4x4_sse2,
      4 => rav1e_sad8x8_sse2,
      5 => rav1e_sad16x16_avx,
      6 => rav1e_sad32x32_avx,
      7 => rav1e_sad64x64_avx,
      8 => rav1e_sad128x128_avx,
      _ => rav1e_sad128x128_avx
    };
    if blk_w == blk_h {
    ...
    #[cfg(all(target_arch = "x86_64", feature = "nasm"))]
    {
      ...
      if mem::size_of::<T>() == 1 && is_x86_feature_detected!("avx") && blk_h >= 4 && blk_w >= 4 {
        return unsafe {
          ...
          sad_avx(plane_org, plane_ref, blk_h, blk_w)
        };
      }
