...
const DQP_Q57: &[i64; FRAME_NSUBTYPES] = &[
  (-0.40699710546814116 * (1i64 << 57) as f64) as i64,
  (0.0 * (1i64 << 57) as f64) as i64,
  (0.7454549778175216 * (1i64 << 57) as f64) as i64,
  (1.1286782799543726 * (1i64 << 57) as f64) as i64,
];
