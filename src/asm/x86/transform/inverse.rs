...
const INV_TXFM_HBD_FNS_10_SSE2: [[Option<InvTxfmHBDFunc>; TX_TYPES_PLUS_LL];
  32] = INV_TXFM_HBD_FNS_16_SSE2;
const INV_TXFM_HBD_FNS_12_SSE2: [[Option<InvTxfmHBDFunc>; TX_TYPES_PLUS_LL];
  32] = INV_TXFM_HBD_FNS_16_SSE2;

const fn merge_hbd_fns(
  a: [[Option<InvTxfmHBDFunc>; TX_TYPES_PLUS_LL]; 32],
  b: [[Option<InvTxfmHBDFunc>; TX_TYPES_PLUS_LL]; 32],
) -> [[Option<InvTxfmHBDFunc>; TX_TYPES_PLUS_LL]; 32] {
  let mut out = b;
  let mut tx_size = 0;
  loop {
    let mut tx_type = 0;
...
const INV_TXFM_HBD_FNS_10_AVX2: [[Option<InvTxfmHBDFunc>; TX_TYPES_PLUS_LL];
  32] = merge_hbd_fns(INV_TXFM_HBD_FNS_10__AVX2, INV_TXFM_HBD_FNS_16_AVX2);
...
const INV_TXFM_HBD_FNS_12_AVX2: [[Option<InvTxfmHBDFunc>; TX_TYPES_PLUS_LL];
  32] = merge_hbd_fns(INV_TXFM_HBD_FNS_12__AVX2, INV_TXFM_HBD_FNS_16_AVX2);
