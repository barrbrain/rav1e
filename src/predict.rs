...
pub(crate) mod native {
  ...
  impl<T: Pixel> Intra<T> for Block4x4 {}
  impl<T: Pixel> Intra<T> for Block8x8 {}
  impl<T: Pixel> Intra<T> for Block16x16 {}
  impl<T: Pixel> Intra<T> for Block32x32 {}
  impl<T: Pixel> Intra<T> for Block64x64 {}

  impl<T: Pixel> Intra<T> for Block4x8 {}
  impl<T: Pixel> Intra<T> for Block8x4 {}
  impl<T: Pixel> Intra<T> for Block8x16 {}
  impl<T: Pixel> Intra<T> for Block16x8 {}
  impl<T: Pixel> Intra<T> for Block16x32 {}
  impl<T: Pixel> Intra<T> for Block32x16 {}
  impl<T: Pixel> Intra<T> for Block32x64 {}
  impl<T: Pixel> Intra<T> for Block64x32 {}

  impl<T: Pixel> Intra<T> for Block4x16 {}
  impl<T: Pixel> Intra<T> for Block16x4 {}
  impl<T: Pixel> Intra<T> for Block8x32 {}
  impl<T: Pixel> Intra<T> for Block32x8 {}
  impl<T: Pixel> Intra<T> for Block16x64 {}
  impl<T: Pixel> Intra<T> for Block64x16 {}
  ...
  pub fn dispatch_predict_intra<T: Pixel>(
    ...
    (match tx_size {
      TxSize::TX_4X4 => predict_intra_inner::<Block4x4, _>,
      TxSize::TX_8X8 => predict_intra_inner::<Block8x8, _>,
      TxSize::TX_16X16 => predict_intra_inner::<Block16x16, _>,
      TxSize::TX_32X32 => predict_intra_inner::<Block32x32, _>,
      TxSize::TX_64X64 => predict_intra_inner::<Block64x64, _>,

      TxSize::TX_4X8 => predict_intra_inner::<Block4x8, _>,
      TxSize::TX_8X4 => predict_intra_inner::<Block8x4, _>,
      TxSize::TX_8X16 => predict_intra_inner::<Block8x16, _>,
      TxSize::TX_16X8 => predict_intra_inner::<Block16x8, _>,
      TxSize::TX_16X32 => predict_intra_inner::<Block16x32, _>,
      TxSize::TX_32X16 => predict_intra_inner::<Block32x16, _>,
      TxSize::TX_32X64 => predict_intra_inner::<Block32x64, _>,
      TxSize::TX_64X32 => predict_intra_inner::<Block64x32, _>,

      TxSize::TX_4X16 => predict_intra_inner::<Block4x16, _>,
      TxSize::TX_16X4 => predict_intra_inner::<Block16x4, _>,
      TxSize::TX_8X32 => predict_intra_inner::<Block8x32, _>,
      TxSize::TX_32X8 => predict_intra_inner::<Block32x8, _>,
      TxSize::TX_16X64 => predict_intra_inner::<Block16x64, _>,
      TxSize::TX_64X16 => predict_intra_inner::<Block64x16, _>,
